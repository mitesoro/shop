<template>
	<view class="container" :data-theme="themeStyle">
		...
		<view class="btn color-base-border ns-gradient-otherpages-member-widthdrawal-withdrawal" :data-theme="themeStyle"
...
<script>
	...
	export default {
		...
		methods: {
			toWithdrawal() {
				this.$util.redirectTo('/otherpages/member/withdrawal/withdrawal');
			},
			//全部提现
			allTx() {
