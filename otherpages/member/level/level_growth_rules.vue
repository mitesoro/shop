	...
	<view class="member-level" :data-theme="themeStyle">
		<view class="grow-explain">
			<view class="explain-title">
				<image :src="$util.img('upload/uniapp/level/growth_that_left.png')" mode="aspectFit"></image>
				成长值说明
				<image :src="$util.img('upload/uniapp/level/growth_that_right.png')" mode="aspectFit"></image>
			</view>
		...
		<view class="grow-value">
			<view class="title">
				<image :src="$util.img('upload/uniapp/level/explain.png')" mode="aspectFit"></image>
				<text>什么是成长值</text>
			</view>
