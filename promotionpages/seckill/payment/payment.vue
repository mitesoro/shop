		...
		<view class="site-wrap">
			...
			<view class="site-footer">
				...
				<view class="order-cell">
					...
					<view class="box text-overflow" @click="openSitePromotion()"><text>限时秒杀</text></view>
					<text class="iconfont iconright"></text>
				</view>
				<view
			...
			<view class="promotion-popup popup">
				...
				<scroll-view scroll-y="true" class="popup-body" :class="{ 'safe-area': isIphoneX }">
					<view>
						<view class="order-cell">
							<text class="tit">
								<text class="promotion-mark ns-gradient-promotionpages-payment" :data-theme="themeStyle">限时秒杀</text>
								{{ orderPaymentData.seckill_info.seckill_name }}
							</text>
							<view class="box"></view>
						</view>
					</view>
