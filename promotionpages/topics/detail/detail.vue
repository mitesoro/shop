<template>
	<view class="topic-detail" :style="{ backgroundColor: bgColor }" :class="themeStyle" :data-theme="themeStyle">
		<mescroll-uni @getData="getData" ref="mescroll" :size="10">
			<block slot="list">
				...
				<view v-if="!dataList.length"><ns-empty text="没有找到相应的商品..."></ns-empty></view>
			</block>
		</mescroll-uni>
