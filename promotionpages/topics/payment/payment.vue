<template>
	<view class="order-container" :class="{ 'safe-area': isIphoneX }" :data-theme="themeStyle">
		...
		<view class="site-wrap">
			...
			<view class="site-footer">
				...
				<view class="order-cell">
					...
					<view class="box text-overflow" @click="openSitePromotion()"><text>专题活动</text></view>
					<text class="iconfont iconright"></text>
				</view>
				<view
		...
		<uni-popup ref="sitePromotionPopup" type="bottom">
			<view class="promotion-popup popup topics-popup">
				<view class="popup-header">
					<text class="tit">活动优惠</text>
				...
				<scroll-view scroll-y="true" class="popup-body" :class="{ 'safe-area': isIphoneX }">
					<view>
						<view class="order-cell">
							<text class="tit">
								<text class="promotion-mark ns-gradient-promotionpages-payment" :data-theme="themeStyle">专题活动</text>
								{{ orderPaymentData.topic_info.topic_name }}
							</text>
							<view class="box"></view>
						</view>
					</view>
