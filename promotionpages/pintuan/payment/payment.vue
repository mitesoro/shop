		...
		<view class="site-wrap">
			...
			<view class="site-body">
				...
				<view class="goods-wrap" v-for="(goodsItem, goodsIndex) in orderPaymentData.shop_goods_list.goods_list" :key="goodsIndex">
					<view class="goods-img" @click="navigateTo(goodsItem.sku_id)">
						<image :src="$util.img(goodsItem.goods_image, { size: 'mid' })" @error="imgError(goodsIndex)" mode="aspectFill"></image>
					</view>
			...
			<view class="site-footer">
				...
				<view class="order-cell">
					...
					<view class="box text-overflow" @click="openSitePromotion()"><text>拼团</text></view>
					<text class="iconfont iconright"></text>
				</view>
				<view
			...
			<view class="promotion-popup popup">
				...
				<scroll-view scroll-y="true" class="popup-body" :class="{ 'safe-area': isIphoneX }">
					<view>
						<view class="order-cell">
							<text class="tit">
								<text class="promotion-mark ns-gradient-promotionpages-payment" :data-theme="themeStyle">拼团</text>
								{{ orderPaymentData.pintuan_info.pintuan_name }}
							</text>
							<view class="box"></view>
						</view>
					</view>
