<template>
	<view class="uni-numbox" :class="{ small: size == 'small' }">
		...
		> -->
		<!-- :style="'background-image:url(' + $util.img('/upload/uniapp/jian.png') + ')'" -->
		<!-- </view> -->
		<input :disabled="disabled" v-model="inputValue" class="uni-input uni-numbox__value" type="number" @input="_onInput" @blur="_onInput" :class="{ small: size == 'small' }" />
		...
		<!-- <view 
			...
			:style="'background-image:url(' + $util.img('/upload/uniapp/jia.png') + ')'"
		>
		</view> -->
	</view>
</template>
